...
use WhatsappBundle\Libaxolotl\DuplicateMessageException;
use WhatsappBundle\Libaxolotl\NoSessionException;
use WhatsappBundle\Libaxolotl\Groups\State\SenderKeyStore;
use WhatsappBundle\Libaxolotl\Protocol\SenderKeyMessage;
