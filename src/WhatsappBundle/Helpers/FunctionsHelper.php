<?php
namespace WhatsappBundle\Helpers;
...
class FunctionsHelper
{
	...
	public function wa_pbkdf2($algorithm, $password, $salt, $count, $key_length, $raw_output = false)
	{
	...
	public function preprocessProfilePicture($path)
	{
	...
	public function createIcon($file)
	{
	...
	public function updateData($nameFile, $WAver, $WAToken = null)
	{
	 ...
	 **/
	public function generatePaymentLink($number, $sku)
	{
	...
	public function deAdjustId($data)
	{
		if (strlen($data) < 4) {
			$data = "\x00" . $data;
		}
	...
	public function unpadV2Plaintext($v2plaintext)
	{
	...
	public function niceVarDump($obj, $ident = 0)
	{
		$data = '';
	...
	public function encodeInt7bit($value)
	{
		$v = $value;
		$out = '';
		while ($v >= 0x80) {
	...
	public function padMessage($plaintext)
	{
		$padded = '';
		$padded .= chr(10);
	...
	public function generateRequestToken($country, $phone, $platform)
	{
		switch ($platform) {
			case 'Android':
